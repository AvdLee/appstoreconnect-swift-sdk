//
//  ReadBuildInformationOfBetaAppReviewSubmissionTests.swift
...
final class ReadBuildInformationOfBetaAppReviewSubmissionTests: XCTestCase {

    func testURLRequest() {
        let endpoint = APIEndpoint.build(
            ofBetaAppReviewSubmissionWithId: "id",
            fields: [.builds(BuildOfBetaAppReviewSubmission.Field.Build.allCases)])
