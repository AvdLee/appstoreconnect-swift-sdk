...
final class ListBetaTestersInBetaGroupTests: XCTestCase {
    ...
    func testURLRequest() {
        ...
        let expected = "https://api.appstoreconnect.apple.com/v1/betaGroups/betaGroupId/betaTesters?fields%5BbetaTester%5D=apps%2CbetaGroups%2Cbuilds%2Cemail%2CfirstName%2CinviteType%2ClastName&limit=2"
