...
final class ListIndividualTestersForBuildTests: XCTestCase {
    ...
    func testURLRequest() {
        ...
        let expected = "https://api.appstoreconnect.apple.com/v1/builds/buildID/individualTesters?fields%5BbetaTester%5D=apps%2CbetaGroups%2Cbuilds%2Cemail%2CfirstName%2CinviteType%2ClastName&limit=2"
