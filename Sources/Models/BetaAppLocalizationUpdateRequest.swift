...
public struct BetaAppLocalizationUpdateRequest: Codable {
    ...
    public init(id: String = UUID().uuidString,
        ...
        data = .init(attributes: .init(description: description, feedbackEmail: feedbackEmail, marketingUrl: marketingUrl, privacyPolicyUrl: privacyPolicyUrl, tvOsPrivacyPolicy: tvOsPrivacyPolicy), id: id)
    }
