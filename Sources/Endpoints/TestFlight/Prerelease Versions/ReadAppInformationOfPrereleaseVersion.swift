//
//  ReadAppInformationOfPrereleaseVersion.swift
...
extension APIEndpoint where T == AppResponse {
    ...
    public static func app(
        ...
        fields: [ReadAppInformationOfPrereleaseVersion.Field]? = nil) -> APIEndpoint {
...
public struct ReadAppInformationOfPrereleaseVersion {
