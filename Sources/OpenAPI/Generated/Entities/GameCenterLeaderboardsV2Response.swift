...
public struct GameCenterLeaderboardsV2Response: Codable {
	...
	public init(data: [GameCenterLeaderboardV2], meta: PagingInformation? = nil, included: [IncludedItem]? = nil, links: PagedDocumentLinks) {
		self.data = data
		self.meta = meta
