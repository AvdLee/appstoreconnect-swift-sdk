...
public struct SubscriptionPlanAvailabilityCreateRequest: Codable {
	...
	public struct Data: Codable {
		...
		public struct Attributes: Codable {
			...
			public init(from decoder: Decoder) throws {
				...
				self.planType = try values.decode(SubscriptionPlanType.self, forKey: "planType")
			}

			public func encode(to encoder: Encoder) throws {
				var values = encoder.container(keyedBy: StringCodingKey.self)
				try values.encodeIfPresent(isAvailableInNewTerritories, forKey: "availableInNewTerritories")
				try values.encode(planType, forKey: "planType")
			}
		}
