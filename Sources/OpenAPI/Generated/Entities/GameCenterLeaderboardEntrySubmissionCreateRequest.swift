...
public struct GameCenterLeaderboardEntrySubmissionCreateRequest: Codable {
	...
	public struct Data: Codable {
		...
		public struct Attributes: Codable {
			...
			public init(score: String, vendorIdentifier: String, challengeIDs: [String]? = nil, context: String? = nil, bundleID: String, scopedPlayerID: String, submittedDate: Date? = nil) {
				self.score = score
