...
public struct InAppPurchaseImageV2: Codable, Identifiable {
	...
	public struct Attributes: Codable {
		...
		public init(fileSize: Int? = nil, fileName: String? = nil, assetToken: String? = nil, imageAsset: ImageAsset? = nil, uploadOperations: [UploadOperation]? = nil, assetDeliveryState: AppMediaAssetState? = nil) {
