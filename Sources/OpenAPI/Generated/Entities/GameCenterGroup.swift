...
public struct GameCenterGroup: Codable, Identifiable {
	...
	public struct Relationships: Codable {
		...
		public init(gameCenterLeaderboardSets: GameCenterLeaderboardSets? = nil, gameCenterLeaderboardsV2: GameCenterLeaderboardsV2? = nil, gameCenterChallenges: GameCenterChallenges? = nil, gameCenterLeaderboardSetsV2: GameCenterLeaderboardSetsV2? = nil, gameCenterLeaderboards: GameCenterLeaderboards? = nil, gameCenterAchievements: GameCenterAchievements? = nil, gameCenterAchievementsV2: GameCenterAchievementsV2? = nil, gameCenterActivities: GameCenterActivities? = nil, gameCenterDetails: GameCenterDetails? = nil) {
