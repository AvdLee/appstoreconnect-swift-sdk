...
public struct GameCenterLeaderboardV2CreateRequest: Codable {
	...
	public struct Data: Codable {
		...
		public struct Relationships: Codable {
			...
			public init(versions: Versions, gameCenterGroup: GameCenterGroup? = nil, gameCenterDetail: GameCenterDetail? = nil, gameCenterLeaderboardSets: GameCenterLeaderboardSets? = nil) {
