...
public struct BetaAppLocalizationCreateRequest: Codable {
	...
	public struct Data: Codable {
		...
		public struct Attributes: Codable {
			...
			public init(locale: String, tvOsPrivacyPolicy: String? = nil, description: String? = nil, marketingURL: String? = nil, privacyPolicyURL: String? = nil, feedbackEmail: String? = nil) {
				self.locale = locale
