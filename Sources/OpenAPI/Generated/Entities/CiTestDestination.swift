...
public struct CiTestDestination: Codable {
	...
	public init(kind: CiTestDestinationKind? = nil, deviceTypeName: String? = nil, runtimeIdentifier: String? = nil, deviceTypeIdentifier: String? = nil, runtimeName: String? = nil) {
		self.kind = kind
