...
public struct SubscriptionVersion: Codable, Identifiable {
	...
	public struct Relationships: Codable {
		...
		public init(subscription: Subscription? = nil, image: Image? = nil, images: Images? = nil, localizations: Localizations? = nil) {
