...
public struct AppUpdateRequest: Codable {
	...
	public struct Data: Codable, Identifiable {
		...
		public struct Attributes: Codable {
			...
			public init(subscriptionStatusURLForSandbox: URL? = nil, accessibilityURL: URL? = nil, contentRightsDeclaration: ContentRightsDeclaration? = nil, subscriptionStatusURLVersionForSandbox: SubscriptionStatusURLVersion? = nil, isStreamlinedPurchasingEnabled: Bool? = nil, subscriptionStatusURLVersion: SubscriptionStatusURLVersion? = nil, subscriptionStatusURL: URL? = nil, primaryLocale: String? = nil, bundleID: String? = nil) {
