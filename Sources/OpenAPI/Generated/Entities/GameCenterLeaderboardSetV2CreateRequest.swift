...
public struct GameCenterLeaderboardSetV2CreateRequest: Codable {
	...
	public struct Data: Codable {
		...
		public struct Relationships: Codable {
			...
			public init(gameCenterDetail: GameCenterDetail? = nil, gameCenterGroup: GameCenterGroup? = nil, versions: Versions, gameCenterLeaderboards: GameCenterLeaderboards? = nil) {
