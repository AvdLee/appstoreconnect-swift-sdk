...
public struct GameCenterActivityUpdateRequest: Codable {
	...
	public struct Data: Codable, Identifiable {
		...
		public struct Attributes: Codable {
			...
			public init(isSupportsPartyCode: Bool? = nil, minimumPlayersCount: Int? = nil, maximumPlayersCount: Int? = nil, playStyle: PlayStyle? = nil, referenceName: String? = nil, isArchived: Bool? = nil, properties: [String: String]? = nil) {
