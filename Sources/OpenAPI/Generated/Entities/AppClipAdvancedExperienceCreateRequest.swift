...
public struct AppClipAdvancedExperienceCreateRequest: Codable {
	...
	public struct Data: Codable {
		...
		public struct Attributes: Codable {
			...
			public init(place: Place? = nil, businessCategory: BusinessCategory? = nil, isPoweredBy: Bool, defaultLanguage: AppClipAdvancedExperienceLanguage, link: URL, action: AppClipAction? = nil) {
				self.place = place
