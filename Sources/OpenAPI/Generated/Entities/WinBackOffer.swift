...
public struct WinBackOffer: Codable, Identifiable {
	...
	public struct Attributes: Codable {
		...
		public init(referenceName: String? = nil, offerID: String? = nil, duration: SubscriptionOfferDuration? = nil, offerMode: SubscriptionOfferMode? = nil, periodCount: Int? = nil, customerEligibilityPaidSubscriptionDurationInMonths: Int? = nil, customerEligibilityTimeSinceLastSubscribedInMonths: IntegerRange? = nil, customerEligibilityWaitBetweenOffersInMonths: Int? = nil, startDate: String? = nil, endDate: String? = nil, priority: Priority? = nil, promotionIntent: PromotionIntent? = nil, targetSubscriptionPlanType: SubscriptionPlanType? = nil) {
