...
public struct AppPreOrder: Codable {
	...
	public struct Attributes: Codable {
		...
		public init(from decoder: Decoder) throws {
			...
			self.preOrderAvailableDate = try values.decodeIfPresent(String.self, forKey: "preOrderAvailableDate")
			self.appReleaseDate = try values.decodeIfPresent(String.self, forKey: "appReleaseDate")
		}

		public func encode(to encoder: Encoder) throws {
			var values = encoder.container(keyedBy: StringCodingKey.self)
			try values.encodeIfPresent(preOrderAvailableDate, forKey: "preOrderAvailableDate")
