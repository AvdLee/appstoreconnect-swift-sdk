...
extension EnterpriseAPIEndpoint.V1.GameCenterLeaderboardSetLocalizations.WithID {
	...
	public struct GameCenterLeaderboardSetImage {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetImageResponse> {
