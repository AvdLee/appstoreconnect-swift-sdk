...
extension EnterpriseAPIEndpoint.V1.AppStoreVersionLocalizations.WithID {
	...
	public struct AppScreenshotSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppScreenshotSetsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "appStoreVersionLocalizations_appScreenshotSets_getToManyRelated")
		}
		...
		public struct GetParameters {
			...
			public init(filterScreenshotDisplayType: [FilterScreenshotDisplayType]? = nil, filterAppCustomProductPageLocalization: [String]? = nil, filterAppStoreVersionExperimentTreatmentLocalization: [String]? = nil, fieldsAppScreenshotSets: [FieldsAppScreenshotSets]? = nil, fieldsAppStoreVersionLocalizations: [FieldsAppStoreVersionLocalizations]? = nil, fieldsAppCustomProductPageLocalizations: [FieldsAppCustomProductPageLocalizations]? = nil, fieldsAppStoreVersionExperimentTreatmentLocalizations: [FieldsAppStoreVersionExperimentTreatmentLocalizations]? = nil, fieldsAppScreenshots: [FieldsAppScreenshots]? = nil, limit: Int? = nil, include: [Include]? = nil, limitAppScreenshots: Int? = nil) {
