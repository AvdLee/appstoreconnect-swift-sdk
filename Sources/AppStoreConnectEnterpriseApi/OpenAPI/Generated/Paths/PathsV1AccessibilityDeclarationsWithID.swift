...
extension EnterpriseAPIEndpoint.V1.AccessibilityDeclarations {
	...
	public struct WithID {
		...
		public func get(fieldsAccessibilityDeclarations: [FieldsAccessibilityDeclarations]? = nil) -> Request<AppStoreConnectEnterpriseApi.AccessibilityDeclarationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AccessibilityDeclarationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AccessibilityDeclarationResponse> {
