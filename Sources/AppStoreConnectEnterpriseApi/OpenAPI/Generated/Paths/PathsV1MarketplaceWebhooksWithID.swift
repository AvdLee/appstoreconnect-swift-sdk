...
extension EnterpriseAPIEndpoint.V1.MarketplaceWebhooks {
	...
	public struct WithID {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.MarketplaceWebhookUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.MarketplaceWebhookResponse> {
