...
extension EnterpriseAPIEndpoint.V1.CiArtifacts {
	...
	public struct WithID {
		...
		public func get(fieldsCiArtifacts: [FieldsCiArtifacts]? = nil) -> Request<AppStoreConnectEnterpriseApi.CiArtifactResponse> {
