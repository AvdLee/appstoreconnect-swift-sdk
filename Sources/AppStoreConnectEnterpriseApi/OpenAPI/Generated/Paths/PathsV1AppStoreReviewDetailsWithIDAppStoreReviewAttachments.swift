...
extension EnterpriseAPIEndpoint.V1.AppStoreReviewDetails.WithID {
	...
	public struct AppStoreReviewAttachments {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppStoreReviewAttachmentsResponse> {
