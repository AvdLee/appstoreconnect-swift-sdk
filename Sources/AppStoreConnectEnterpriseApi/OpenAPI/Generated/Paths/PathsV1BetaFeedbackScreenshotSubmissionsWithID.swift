...
extension EnterpriseAPIEndpoint.V1.BetaFeedbackScreenshotSubmissions {
	...
	public struct WithID {
		...
		public func get(fieldsBetaFeedbackScreenshotSubmissions: [FieldsBetaFeedbackScreenshotSubmissions]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaFeedbackScreenshotSubmissionResponse> {
