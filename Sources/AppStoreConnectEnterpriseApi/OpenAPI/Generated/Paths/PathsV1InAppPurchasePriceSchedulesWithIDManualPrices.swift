...
extension EnterpriseAPIEndpoint.V1.InAppPurchasePriceSchedules.WithID {
	...
	public struct ManualPrices {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.InAppPurchasePricesResponse> {
