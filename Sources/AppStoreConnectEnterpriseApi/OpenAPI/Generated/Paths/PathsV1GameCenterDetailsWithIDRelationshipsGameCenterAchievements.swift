...
extension EnterpriseAPIEndpoint.V1.GameCenterDetails.WithID.Relationships {
	...
	public struct GameCenterAchievements {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterDetailGameCenterAchievementsLinkagesResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterDetailGameCenterAchievementsLinkagesRequest) -> Request<Void> {
