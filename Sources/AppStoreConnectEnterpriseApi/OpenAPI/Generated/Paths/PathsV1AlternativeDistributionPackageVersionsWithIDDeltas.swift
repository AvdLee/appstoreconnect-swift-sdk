...
extension EnterpriseAPIEndpoint.V1.AlternativeDistributionPackageVersions.WithID {
	...
	public struct Deltas {
		...
		public func get(fieldsAlternativeDistributionPackageDeltas: [FieldsAlternativeDistributionPackageDeltas]? = nil, limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.AlternativeDistributionPackageDeltasResponse> {
