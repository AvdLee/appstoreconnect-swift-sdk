...
extension EnterpriseAPIEndpoint.V1.AppEvents {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppEventResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppEventUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppEventResponse> {
