...
extension EnterpriseAPIEndpoint.V1.Apps.WithID {
	...
	public struct EndUserLicenseAgreement {
		...
		public func get(fieldsEndUserLicenseAgreements: [FieldsEndUserLicenseAgreements]? = nil) -> Request<AppStoreConnectEnterpriseApi.EndUserLicenseAgreementWithoutIncludesResponse> {
