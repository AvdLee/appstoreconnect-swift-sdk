...
extension EnterpriseAPIEndpoint.V1.PromotedPurchases {
	...
	public struct WithID {
		...
		public func get(fieldsPromotedPurchases: [FieldsPromotedPurchases]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.PromotedPurchaseResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.PromotedPurchaseUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.PromotedPurchaseResponse> {
