...
extension EnterpriseAPIEndpoint.V1.SubscriptionOfferCodes {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.SubscriptionOfferCodeResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.SubscriptionOfferCodeUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.SubscriptionOfferCodeResponse> {
