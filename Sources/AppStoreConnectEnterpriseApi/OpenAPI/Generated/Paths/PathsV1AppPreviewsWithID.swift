...
extension EnterpriseAPIEndpoint.V1.AppPreviews {
	...
	public struct WithID {
		...
		public func get(fieldsAppPreviews: [FieldsAppPreviews]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.AppPreviewResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppPreviewUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppPreviewResponse> {
