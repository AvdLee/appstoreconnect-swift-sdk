...
extension EnterpriseAPIEndpoint.V1.AppEventVideoClips {
	...
	public struct WithID {
		...
		public func get(fieldsAppEventVideoClips: [FieldsAppEventVideoClips]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.AppEventVideoClipResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppEventVideoClipUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppEventVideoClipResponse> {
