...
extension EnterpriseAPIEndpoint.V1.GameCenterAppVersions.WithID.Relationships {
	...
	public struct CompatibilityVersions {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAppVersionCompatibilityVersionsLinkagesResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.GameCenterAppVersionCompatibilityVersionsLinkagesRequest) -> Request<Void> {
			Request(path: path, method: "POST", body: body, id: "gameCenterAppVersions_compatibilityVersions_createToManyRelationship")
		}

		public func delete(_ body: AppStoreConnectEnterpriseApi.GameCenterAppVersionCompatibilityVersionsLinkagesRequest) -> Request<Void> {
