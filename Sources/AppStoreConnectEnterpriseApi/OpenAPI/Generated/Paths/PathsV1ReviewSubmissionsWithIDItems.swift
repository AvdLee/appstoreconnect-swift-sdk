...
extension EnterpriseAPIEndpoint.V1.ReviewSubmissions.WithID {
	...
	public struct Items {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.ReviewSubmissionItemsResponse> {
