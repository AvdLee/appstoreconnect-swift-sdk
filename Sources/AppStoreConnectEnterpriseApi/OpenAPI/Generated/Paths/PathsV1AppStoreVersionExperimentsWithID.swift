...
extension EnterpriseAPIEndpoint.V1.AppStoreVersionExperiments {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppStoreVersionExperimentResponse> {
		...
		@available(*, deprecated, message: "Deprecated")
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppStoreVersionExperimentUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppStoreVersionExperimentResponse> {
