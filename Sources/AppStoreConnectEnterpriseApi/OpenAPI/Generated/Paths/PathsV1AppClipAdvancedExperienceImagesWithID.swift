...
extension EnterpriseAPIEndpoint.V1.AppClipAdvancedExperienceImages {
	...
	public struct WithID {
		...
		public func get(fieldsAppClipAdvancedExperienceImages: [FieldsAppClipAdvancedExperienceImages]? = nil) -> Request<AppStoreConnectEnterpriseApi.AppClipAdvancedExperienceImageResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppClipAdvancedExperienceImageUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppClipAdvancedExperienceImageResponse> {
