...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct AppCustomProductPages {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.AppCustomProductPageCreateRequest) -> Request<AppStoreConnectEnterpriseApi.AppCustomProductPageResponse> {
