...
extension EnterpriseAPIEndpoint.V1.ReviewSubmissions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.ReviewSubmissionResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.ReviewSubmissionUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.ReviewSubmissionResponse> {
