...
extension EnterpriseAPIEndpoint.V1.GameCenterChallenges {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterChallengeResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterChallengeUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterChallengeResponse> {
