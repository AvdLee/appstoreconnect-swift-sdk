...
extension EnterpriseAPIEndpoint.V1.SubscriptionPromotionalOffers {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.SubscriptionPromotionalOfferResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.SubscriptionPromotionalOfferUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.SubscriptionPromotionalOfferResponse> {
