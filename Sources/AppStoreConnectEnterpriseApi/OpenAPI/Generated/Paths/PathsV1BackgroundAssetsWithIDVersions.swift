...
extension EnterpriseAPIEndpoint.V1.BackgroundAssets.WithID {
	...
	public struct Versions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BackgroundAssetVersionsResponse> {
