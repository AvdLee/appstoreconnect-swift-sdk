...
extension EnterpriseAPIEndpoint.V1.BetaAppClipInvocations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaAppClipInvocationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.BetaAppClipInvocationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaAppClipInvocationResponse> {
