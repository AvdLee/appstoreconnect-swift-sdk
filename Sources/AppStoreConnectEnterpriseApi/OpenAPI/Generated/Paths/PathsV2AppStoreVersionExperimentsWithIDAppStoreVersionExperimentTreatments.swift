...
extension EnterpriseAPIEndpoint.V2.AppStoreVersionExperiments.WithID {
	...
	public struct AppStoreVersionExperimentTreatments {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppStoreVersionExperimentTreatmentsResponse> {
