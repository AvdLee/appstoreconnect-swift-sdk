...
extension EnterpriseAPIEndpoint.V1.AppStoreVersions.WithID {
	...
	public struct AgeRatingDeclaration {
		...
		public func get(fieldsAgeRatingDeclarations: [FieldsAgeRatingDeclarations]? = nil) -> Request<AppStoreConnectEnterpriseApi.AgeRatingDeclarationWithoutIncludesResponse> {
