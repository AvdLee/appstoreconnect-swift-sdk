...
extension EnterpriseAPIEndpoint.V1.AnalyticsReportInstances {
	...
	public struct WithID {
		...
		public func get(fieldsAnalyticsReportInstances: [FieldsAnalyticsReportInstances]? = nil) -> Request<AppStoreConnectEnterpriseApi.AnalyticsReportInstanceResponse> {
