...
extension EnterpriseAPIEndpoint.V1.GameCenterGroups {
	...
	public struct WithID {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterGroupUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterGroupResponse> {
