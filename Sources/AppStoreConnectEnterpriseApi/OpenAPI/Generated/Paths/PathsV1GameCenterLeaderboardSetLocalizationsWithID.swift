...
extension EnterpriseAPIEndpoint.V1.GameCenterLeaderboardSetLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetLocalizationResponse> {
