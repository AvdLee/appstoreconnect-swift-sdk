...
extension EnterpriseAPIEndpoint.V1.AnalyticsReports {
	...
	public struct WithID {
		...
		public func get(fieldsAnalyticsReports: [FieldsAnalyticsReports]? = nil) -> Request<AppStoreConnectEnterpriseApi.AnalyticsReportResponse> {
