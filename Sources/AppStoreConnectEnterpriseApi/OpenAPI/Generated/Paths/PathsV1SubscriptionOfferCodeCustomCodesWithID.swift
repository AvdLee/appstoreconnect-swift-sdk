...
extension EnterpriseAPIEndpoint.V1.SubscriptionOfferCodeCustomCodes {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionOfferCodeCustomCodes: [FieldsSubscriptionOfferCodeCustomCodes]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.SubscriptionOfferCodeCustomCodeResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.SubscriptionOfferCodeCustomCodeUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.SubscriptionOfferCodeCustomCodeResponse> {
