...
extension EnterpriseAPIEndpoint.V1.AppStoreVersionExperiments.WithID {
	...
	public struct AppStoreVersionExperimentTreatments {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppStoreVersionExperimentTreatmentsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "appStoreVersionExperiments_appStoreVersionExperimentTreatments_getToManyRelated")
		}
