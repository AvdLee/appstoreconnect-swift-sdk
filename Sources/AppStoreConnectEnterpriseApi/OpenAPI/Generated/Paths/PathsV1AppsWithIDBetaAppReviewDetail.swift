...
extension EnterpriseAPIEndpoint.V1.Apps.WithID {
	...
	public struct BetaAppReviewDetail {
		...
		public func get(fieldsBetaAppReviewDetails: [FieldsBetaAppReviewDetails]? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaAppReviewDetailWithoutIncludesResponse> {
