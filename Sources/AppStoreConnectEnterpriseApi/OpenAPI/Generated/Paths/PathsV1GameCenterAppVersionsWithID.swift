...
extension EnterpriseAPIEndpoint.V1.GameCenterAppVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAppVersionResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterAppVersionUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterAppVersionResponse> {
