...
extension EnterpriseAPIEndpoint.V1.SubscriptionPricePoints.WithID {
	...
	public struct Equalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.SubscriptionPricePointsResponse> {
