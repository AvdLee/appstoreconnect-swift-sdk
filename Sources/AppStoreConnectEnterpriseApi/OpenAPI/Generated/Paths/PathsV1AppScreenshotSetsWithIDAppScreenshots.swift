...
extension EnterpriseAPIEndpoint.V1.AppScreenshotSets.WithID {
	...
	public struct AppScreenshots {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppScreenshotsResponse> {
