...
extension EnterpriseAPIEndpoint.V1.GameCenterAchievements {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAchievementResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterAchievementUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterAchievementResponse> {
