...
extension EnterpriseAPIEndpoint.V1.RoutingAppCoverages {
	...
	public struct WithID {
		...
		public func get(fieldsRoutingAppCoverages: [FieldsRoutingAppCoverages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.RoutingAppCoverageResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.RoutingAppCoverageUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.RoutingAppCoverageResponse> {
