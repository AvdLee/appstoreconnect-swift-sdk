...
extension EnterpriseAPIEndpoint.V1.GameCenterAppVersions.WithID {
	...
	public struct CompatibilityVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAppVersionsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "gameCenterAppVersions_compatibilityVersions_getToManyRelated")
		}
