...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct CiXcodeVersions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.CiXcodeVersionsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "ciXcodeVersions_getCollection")
		}
