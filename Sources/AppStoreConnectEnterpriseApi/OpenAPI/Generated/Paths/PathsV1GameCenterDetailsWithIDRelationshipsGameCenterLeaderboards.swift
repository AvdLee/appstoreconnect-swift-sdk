...
extension EnterpriseAPIEndpoint.V1.GameCenterDetails.WithID.Relationships {
	...
	public struct GameCenterLeaderboards {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterDetailGameCenterLeaderboardsLinkagesResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterDetailGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
