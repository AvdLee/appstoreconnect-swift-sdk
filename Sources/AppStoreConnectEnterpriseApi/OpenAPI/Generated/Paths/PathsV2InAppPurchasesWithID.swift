...
extension EnterpriseAPIEndpoint.V2.InAppPurchases {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.InAppPurchaseV2Response> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.InAppPurchaseV2UpdateRequest) -> Request<AppStoreConnectEnterpriseApi.InAppPurchaseV2Response> {
