...
extension EnterpriseAPIEndpoint.V1.Builds.WithID {
	...
	public struct BetaAppReviewSubmission {
		...
		public func get(fieldsBetaAppReviewSubmissions: [FieldsBetaAppReviewSubmissions]? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaAppReviewSubmissionWithoutIncludesResponse> {
