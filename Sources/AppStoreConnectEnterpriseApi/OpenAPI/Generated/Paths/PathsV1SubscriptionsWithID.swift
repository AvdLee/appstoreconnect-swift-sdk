...
extension EnterpriseAPIEndpoint.V1.Subscriptions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.SubscriptionResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.SubscriptionUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.SubscriptionResponse> {
