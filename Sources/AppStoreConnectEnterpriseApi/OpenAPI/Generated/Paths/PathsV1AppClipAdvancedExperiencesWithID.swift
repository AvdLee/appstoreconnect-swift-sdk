...
extension EnterpriseAPIEndpoint.V1.AppClipAdvancedExperiences {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppClipAdvancedExperienceResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppClipAdvancedExperienceUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppClipAdvancedExperienceResponse> {
