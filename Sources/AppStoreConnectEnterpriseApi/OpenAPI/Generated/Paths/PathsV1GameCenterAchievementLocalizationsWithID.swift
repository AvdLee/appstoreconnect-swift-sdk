...
extension EnterpriseAPIEndpoint.V1.GameCenterAchievementLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAchievementLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterAchievementLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterAchievementLocalizationResponse> {
