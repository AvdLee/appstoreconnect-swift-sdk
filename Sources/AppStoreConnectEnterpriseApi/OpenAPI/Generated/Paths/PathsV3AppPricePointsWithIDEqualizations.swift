...
extension EnterpriseAPIEndpoint.V3.AppPricePoints.WithID {
	...
	public struct Equalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppPricePointsV3Response> {
