...
extension EnterpriseAPIEndpoint.V1.GameCenterAchievements.WithID {
	...
	public struct Localizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAchievementLocalizationsResponse> {
