...
extension EnterpriseAPIEndpoint.V1.Apps.WithID {
	...
	public struct PreReleaseVersions {
		...
		public func get(fieldsPreReleaseVersions: [FieldsPreReleaseVersions]? = nil, limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.PreReleaseVersionsWithoutIncludesResponse> {
