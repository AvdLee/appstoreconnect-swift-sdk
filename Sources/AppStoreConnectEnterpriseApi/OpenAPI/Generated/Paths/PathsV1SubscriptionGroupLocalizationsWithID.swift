...
extension EnterpriseAPIEndpoint.V1.SubscriptionGroupLocalizations {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionGroupLocalizations: [FieldsSubscriptionGroupLocalizations]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.SubscriptionGroupLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.SubscriptionGroupLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.SubscriptionGroupLocalizationResponse> {
