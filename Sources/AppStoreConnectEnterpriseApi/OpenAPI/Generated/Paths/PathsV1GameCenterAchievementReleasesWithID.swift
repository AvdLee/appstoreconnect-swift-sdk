...
extension EnterpriseAPIEndpoint.V1.GameCenterAchievementReleases {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterAchievementReleases: [FieldsGameCenterAchievementReleases]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterAchievementReleaseResponse> {
