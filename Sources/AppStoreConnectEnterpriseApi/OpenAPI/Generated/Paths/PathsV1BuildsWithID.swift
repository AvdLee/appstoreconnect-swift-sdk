...
extension EnterpriseAPIEndpoint.V1.Builds {
	...
	public struct WithID {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.BuildUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.BuildResponse> {
