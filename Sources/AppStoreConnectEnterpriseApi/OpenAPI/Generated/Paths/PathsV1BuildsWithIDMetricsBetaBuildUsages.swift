...
extension EnterpriseAPIEndpoint.V1.Builds.WithID.Metrics {
	...
	public struct BetaBuildUsages {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaBuildUsagesV1MetricResponse> {
