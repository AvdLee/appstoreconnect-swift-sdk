...
extension EnterpriseAPIEndpoint.V1.GameCenterActivities {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterActivityResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterActivityUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterActivityResponse> {
