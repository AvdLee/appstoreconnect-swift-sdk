...
extension EnterpriseAPIEndpoint.V1.GameCenterChallengeVersionReleases {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterChallengeVersionReleases: [FieldsGameCenterChallengeVersionReleases]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterChallengeVersionReleaseResponse> {
