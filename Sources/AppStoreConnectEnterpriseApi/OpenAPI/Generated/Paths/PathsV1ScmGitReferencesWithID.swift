...
extension EnterpriseAPIEndpoint.V1.ScmGitReferences {
	...
	public struct WithID {
		...
		public func get(fieldsScmGitReferences: [FieldsScmGitReferences]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.ScmGitReferenceResponse> {
