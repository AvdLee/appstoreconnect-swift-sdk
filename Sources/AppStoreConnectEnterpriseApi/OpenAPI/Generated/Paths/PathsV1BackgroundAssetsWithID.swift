...
extension EnterpriseAPIEndpoint.V1.BackgroundAssets {
	...
	public struct WithID {
		...
		public func get(fieldsBackgroundAssets: [FieldsBackgroundAssets]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.BackgroundAssetResponse> {
