...
extension EnterpriseAPIEndpoint.V1.ScmRepositories {
	...
	public struct WithID {
		...
		public func get(fieldsScmRepositories: [FieldsScmRepositories]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.ScmRepositoryResponse> {
