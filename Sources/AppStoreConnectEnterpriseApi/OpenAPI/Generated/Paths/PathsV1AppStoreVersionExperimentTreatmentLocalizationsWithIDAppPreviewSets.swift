...
extension EnterpriseAPIEndpoint.V1.AppStoreVersionExperimentTreatmentLocalizations.WithID {
	...
	public struct AppPreviewSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppPreviewSetsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "appStoreVersionExperimentTreatmentLocalizations_appPreviewSets_getToManyRelated")
		}
