...
extension EnterpriseAPIEndpoint.V1.BetaGroups {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaGroupResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.BetaGroupUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaGroupResponse> {
