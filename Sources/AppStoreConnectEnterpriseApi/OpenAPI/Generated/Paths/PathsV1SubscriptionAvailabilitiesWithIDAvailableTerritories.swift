...
extension EnterpriseAPIEndpoint.V1.SubscriptionAvailabilities.WithID {
	...
	public struct AvailableTerritories {
		...
		public func get(fieldsTerritories: [FieldsTerritories]? = nil, limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.TerritoriesResponse> {
			Request(path: path, method: "GET", query: makeGetQuery(fieldsTerritories, limit), id: "subscriptionAvailabilities_availableTerritories_getToManyRelated")
		}
