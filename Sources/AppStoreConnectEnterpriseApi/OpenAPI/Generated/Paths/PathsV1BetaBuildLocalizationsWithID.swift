...
extension EnterpriseAPIEndpoint.V1.BetaBuildLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaBuildLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.BetaBuildLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaBuildLocalizationResponse> {
