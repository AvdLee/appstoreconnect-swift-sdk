...
extension EnterpriseAPIEndpoint.V1.Builds.WithID {
	...
	public struct AppEncryptionDeclaration {
		...
		public func get(fieldsAppEncryptionDeclarations: [FieldsAppEncryptionDeclarations]? = nil) -> Request<AppStoreConnectEnterpriseApi.AppEncryptionDeclarationWithoutIncludesResponse> {
