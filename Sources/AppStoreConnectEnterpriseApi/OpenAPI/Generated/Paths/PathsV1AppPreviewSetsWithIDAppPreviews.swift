...
extension EnterpriseAPIEndpoint.V1.AppPreviewSets.WithID {
	...
	public struct AppPreviews {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppPreviewsResponse> {
