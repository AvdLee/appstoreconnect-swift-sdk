...
extension EnterpriseAPIEndpoint.V1.InAppPurchaseAppStoreReviewScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsInAppPurchaseAppStoreReviewScreenshots: [FieldsInAppPurchaseAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.InAppPurchaseAppStoreReviewScreenshotResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.InAppPurchaseAppStoreReviewScreenshotUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.InAppPurchaseAppStoreReviewScreenshotResponse> {
