...
extension EnterpriseAPIEndpoint.V1.InAppPurchaseImages {
	...
	public struct WithID {
		...
		public func get(fieldsInAppPurchaseImages: [FieldsInAppPurchaseImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.InAppPurchaseImageResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.InAppPurchaseImageUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.InAppPurchaseImageResponse> {
