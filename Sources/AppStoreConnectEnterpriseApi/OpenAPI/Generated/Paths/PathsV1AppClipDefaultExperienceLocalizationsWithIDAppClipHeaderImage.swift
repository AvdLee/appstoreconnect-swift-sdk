...
extension EnterpriseAPIEndpoint.V1.AppClipDefaultExperienceLocalizations.WithID {
	...
	public struct AppClipHeaderImage {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppClipHeaderImageResponse> {
