...
extension EnterpriseAPIEndpoint.V1.GameCenterGroups.WithID.Relationships {
	...
	public struct GameCenterAchievements {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterGroupGameCenterAchievementsLinkagesResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterGroupGameCenterAchievementsLinkagesRequest) -> Request<Void> {
