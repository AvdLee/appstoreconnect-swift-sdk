...
extension EnterpriseAPIEndpoint.V1.GameCenterLeaderboardLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterLeaderboardLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardLocalizationResponse> {
