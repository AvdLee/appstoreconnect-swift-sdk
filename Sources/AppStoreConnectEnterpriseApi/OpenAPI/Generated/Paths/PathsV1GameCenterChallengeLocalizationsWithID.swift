...
extension EnterpriseAPIEndpoint.V1.GameCenterChallengeLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterChallengeLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterChallengeLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterChallengeLocalizationResponse> {
