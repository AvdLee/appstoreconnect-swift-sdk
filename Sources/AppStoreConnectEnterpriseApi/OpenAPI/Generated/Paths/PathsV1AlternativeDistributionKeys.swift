...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct AlternativeDistributionKeys {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AlternativeDistributionKeysResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.AlternativeDistributionKeyCreateRequest) -> Request<AppStoreConnectEnterpriseApi.AlternativeDistributionKeyResponse> {
