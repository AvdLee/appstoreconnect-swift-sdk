...
extension EnterpriseAPIEndpoint.V1.GameCenterDetails.WithID.Metrics {
	...
	public struct RuleBasedMatchmakingRequests {
		...
		public func get(parameters: GetParameters) -> Request<AppStoreConnectEnterpriseApi.GameCenterMatchmakingAppRequestsV1MetricResponse> {
