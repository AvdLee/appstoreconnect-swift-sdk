...
extension EnterpriseAPIEndpoint.V1.Apps.WithID {
	...
	public struct MarketplaceSearchDetail {
		...
		public func get(fieldsMarketplaceSearchDetails: [FieldsMarketplaceSearchDetails]? = nil) -> Request<AppStoreConnectEnterpriseApi.MarketplaceSearchDetailResponse> {
