...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct BetaGroups {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaGroupsResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.BetaGroupCreateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaGroupResponse> {
