...
extension EnterpriseAPIEndpoint.V1.ScmProviders {
	...
	public struct WithID {
		...
		public func get(fieldsScmProviders: [FieldsScmProviders]? = nil) -> Request<AppStoreConnectEnterpriseApi.ScmProviderResponse> {
