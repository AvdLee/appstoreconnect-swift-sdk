...
extension EnterpriseAPIEndpoint.V1.ScmRepositories.WithID {
	...
	public struct GitReferences {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.ScmGitReferencesResponse> {
