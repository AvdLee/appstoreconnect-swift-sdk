...
extension EnterpriseAPIEndpoint.V1.GameCenterMatchmakingQueues {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterMatchmakingQueues: [FieldsGameCenterMatchmakingQueues]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterMatchmakingQueueResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterMatchmakingQueueUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterMatchmakingQueueResponse> {
