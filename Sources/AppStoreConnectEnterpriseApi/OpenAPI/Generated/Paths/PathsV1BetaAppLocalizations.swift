...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct BetaAppLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaAppLocalizationsResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.BetaAppLocalizationCreateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaAppLocalizationResponse> {
