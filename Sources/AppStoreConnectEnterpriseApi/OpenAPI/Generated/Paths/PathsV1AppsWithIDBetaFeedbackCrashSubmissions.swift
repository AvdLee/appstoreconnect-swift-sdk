...
extension EnterpriseAPIEndpoint.V1.Apps.WithID {
	...
	public struct BetaFeedbackCrashSubmissions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaFeedbackCrashSubmissionsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "apps_betaFeedbackCrashSubmissions_getToManyRelated")
		}
