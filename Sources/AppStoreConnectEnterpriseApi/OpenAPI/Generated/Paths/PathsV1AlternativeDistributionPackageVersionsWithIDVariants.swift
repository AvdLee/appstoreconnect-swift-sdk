...
extension EnterpriseAPIEndpoint.V1.AlternativeDistributionPackageVersions.WithID {
	...
	public struct Variants {
		...
		public func get(fieldsAlternativeDistributionPackageVariants: [FieldsAlternativeDistributionPackageVariants]? = nil, limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.AlternativeDistributionPackageVariantsResponse> {
