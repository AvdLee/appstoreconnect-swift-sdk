...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct InAppPurchasePriceSchedules {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.InAppPurchasePriceScheduleCreateRequest) -> Request<AppStoreConnectEnterpriseApi.InAppPurchasePriceScheduleResponse> {
