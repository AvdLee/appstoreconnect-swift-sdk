...
extension EnterpriseAPIEndpoint.V1.Apps {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "apps_getInstance")
		}
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppResponse> {
