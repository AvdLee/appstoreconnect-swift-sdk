...
extension EnterpriseAPIEndpoint.V1.AppStoreVersions.WithID {
	...
	public struct RoutingAppCoverage {
		...
		public func get(fieldsRoutingAppCoverages: [FieldsRoutingAppCoverages]? = nil) -> Request<AppStoreConnectEnterpriseApi.RoutingAppCoverageWithoutIncludesResponse> {
