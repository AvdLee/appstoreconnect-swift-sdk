...
extension EnterpriseAPIEndpoint.V1.AnalyticsReports.WithID {
	...
	public struct Instances {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AnalyticsReportInstancesResponse> {
