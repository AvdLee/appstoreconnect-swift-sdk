...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct Nominations {
		...
		public func get(parameters: GetParameters) -> Request<AppStoreConnectEnterpriseApi.NominationsResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.NominationCreateRequest) -> Request<AppStoreConnectEnterpriseApi.NominationResponse> {
