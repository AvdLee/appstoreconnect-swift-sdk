...
extension EnterpriseAPIEndpoint.V1.GameCenterMatchmakingRuleSets {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterMatchmakingRuleSetResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterMatchmakingRuleSetUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterMatchmakingRuleSetResponse> {
