...
extension EnterpriseAPIEndpoint.V1.WinBackOffers.WithID.Relationships {
	...
	public struct Prices {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.WinBackOfferPricesLinkagesResponse> {
