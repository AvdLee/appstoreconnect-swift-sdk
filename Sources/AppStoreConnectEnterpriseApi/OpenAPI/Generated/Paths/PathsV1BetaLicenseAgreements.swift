...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct BetaLicenseAgreements {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaLicenseAgreementsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "betaLicenseAgreements_getCollection")
		}
		...
		public struct GetParameters {
			...
			public init(filterApp: [String]? = nil, fieldsBetaLicenseAgreements: [FieldsBetaLicenseAgreements]? = nil, fieldsApps: [FieldsApps]? = nil, limit: Int? = nil, include: [Include]? = nil) {
