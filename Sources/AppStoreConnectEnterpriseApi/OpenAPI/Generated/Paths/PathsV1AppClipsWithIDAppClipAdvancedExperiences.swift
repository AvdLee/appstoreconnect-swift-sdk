...
extension EnterpriseAPIEndpoint.V1.AppClips.WithID {
	...
	public struct AppClipAdvancedExperiences {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppClipAdvancedExperiencesResponse> {
