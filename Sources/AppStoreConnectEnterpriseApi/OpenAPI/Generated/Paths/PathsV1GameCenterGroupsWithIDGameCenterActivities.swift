...
extension EnterpriseAPIEndpoint.V1.GameCenterGroups.WithID {
	...
	public struct GameCenterActivities {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterActivitiesResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "gameCenterGroups_gameCenterActivities_getToManyRelated")
		}
