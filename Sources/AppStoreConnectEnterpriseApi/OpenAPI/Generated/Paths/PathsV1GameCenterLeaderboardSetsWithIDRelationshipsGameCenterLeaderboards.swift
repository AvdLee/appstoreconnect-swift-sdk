...
extension EnterpriseAPIEndpoint.V1.GameCenterLeaderboardSets.WithID.Relationships {
	...
	public struct GameCenterLeaderboards {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
			Request(path: path, method: "POST", body: body, id: "gameCenterLeaderboardSets_gameCenterLeaderboards_createToManyRelationship")
		}

		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
			Request(path: path, method: "PATCH", body: body, id: "gameCenterLeaderboardSets_gameCenterLeaderboards_replaceToManyRelationship")
		}

		public func delete(_ body: AppStoreConnectEnterpriseApi.GameCenterLeaderboardSetGameCenterLeaderboardsLinkagesRequest) -> Request<Void> {
