...
extension EnterpriseAPIEndpoint.V1.GameCenterActivityLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterActivityLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterActivityLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterActivityLocalizationResponse> {
