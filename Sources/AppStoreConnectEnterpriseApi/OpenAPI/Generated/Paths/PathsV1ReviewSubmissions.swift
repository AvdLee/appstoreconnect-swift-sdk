...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct ReviewSubmissions {
		...
		public func get(parameters: GetParameters) -> Request<AppStoreConnectEnterpriseApi.ReviewSubmissionsResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.ReviewSubmissionCreateRequest) -> Request<AppStoreConnectEnterpriseApi.ReviewSubmissionResponse> {
