...
extension EnterpriseAPIEndpoint.V1.GameCenterDetails.WithID {
	...
	public struct GameCenterChallenges {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterChallengesResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "gameCenterDetails_gameCenterChallenges_getToManyRelated")
		}
