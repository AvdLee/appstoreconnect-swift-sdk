...
extension EnterpriseAPIEndpoint.V1.AlternativeDistributionPackages.WithID {
	...
	public struct Versions {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AlternativeDistributionPackageVersionsResponse> {
