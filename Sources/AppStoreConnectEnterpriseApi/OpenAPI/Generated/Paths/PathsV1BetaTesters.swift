...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct BetaTesters {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaTestersResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.BetaTesterCreateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaTesterResponse> {
