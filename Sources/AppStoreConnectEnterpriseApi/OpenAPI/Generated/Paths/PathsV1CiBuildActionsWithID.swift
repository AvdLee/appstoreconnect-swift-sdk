...
extension EnterpriseAPIEndpoint.V1.CiBuildActions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.CiBuildActionResponse> {
