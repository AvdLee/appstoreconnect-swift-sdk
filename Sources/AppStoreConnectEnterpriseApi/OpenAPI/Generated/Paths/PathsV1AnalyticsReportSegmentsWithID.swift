...
extension EnterpriseAPIEndpoint.V1.AnalyticsReportSegments {
	...
	public struct WithID {
		...
		public func get(fieldsAnalyticsReportSegments: [FieldsAnalyticsReportSegments]? = nil) -> Request<AppStoreConnectEnterpriseApi.AnalyticsReportSegmentResponse> {
