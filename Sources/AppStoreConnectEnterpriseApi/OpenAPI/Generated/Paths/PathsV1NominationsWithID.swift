...
extension EnterpriseAPIEndpoint.V1.Nominations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.NominationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.NominationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.NominationResponse> {
