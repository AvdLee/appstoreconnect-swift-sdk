...
extension EnterpriseAPIEndpoint.V1.GameCenterActivities.WithID.Relationships {
	...
	public struct Achievements {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.GameCenterActivityAchievementsLinkagesRequest) -> Request<Void> {
			Request(path: path, method: "POST", body: body, id: "gameCenterActivities_achievements_createToManyRelationship")
		}

		public func delete(_ body: AppStoreConnectEnterpriseApi.GameCenterActivityAchievementsLinkagesRequest) -> Request<Void> {
