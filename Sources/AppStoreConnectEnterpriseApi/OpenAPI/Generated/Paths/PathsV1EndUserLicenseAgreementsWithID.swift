...
extension EnterpriseAPIEndpoint.V1.EndUserLicenseAgreements {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.EndUserLicenseAgreementResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.EndUserLicenseAgreementUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.EndUserLicenseAgreementResponse> {
