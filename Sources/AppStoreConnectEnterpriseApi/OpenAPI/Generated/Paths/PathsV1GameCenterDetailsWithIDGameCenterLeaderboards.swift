...
extension EnterpriseAPIEndpoint.V1.GameCenterDetails.WithID {
	...
	public struct GameCenterLeaderboards {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardsResponse> {
			Request(path: path, method: "GET", query: parameters?.asQuery, id: "gameCenterDetails_gameCenterLeaderboards_getToManyRelated")
		}
