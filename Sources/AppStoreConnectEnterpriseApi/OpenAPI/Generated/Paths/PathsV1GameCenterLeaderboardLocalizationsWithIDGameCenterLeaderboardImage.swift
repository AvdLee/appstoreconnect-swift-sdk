...
extension EnterpriseAPIEndpoint.V1.GameCenterLeaderboardLocalizations.WithID {
	...
	public struct GameCenterLeaderboardImage {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardImageResponse> {
