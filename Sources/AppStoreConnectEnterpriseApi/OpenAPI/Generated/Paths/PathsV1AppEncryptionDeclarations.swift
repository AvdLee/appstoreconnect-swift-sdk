...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct AppEncryptionDeclarations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppEncryptionDeclarationsResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.AppEncryptionDeclarationCreateRequest) -> Request<AppStoreConnectEnterpriseApi.AppEncryptionDeclarationResponse> {
