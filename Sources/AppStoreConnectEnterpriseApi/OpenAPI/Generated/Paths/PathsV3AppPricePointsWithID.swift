...
extension EnterpriseAPIEndpoint.V3.AppPricePoints {
	...
	public struct WithID {
		...
		public func get(fieldsAppPricePoints: [FieldsAppPricePoints]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.AppPricePointV3Response> {
