...
extension EnterpriseAPIEndpoint.V1.AppClipDefaultExperienceLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppClipDefaultExperienceLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppClipDefaultExperienceLocalizationUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppClipDefaultExperienceLocalizationResponse> {
