...
extension EnterpriseAPIEndpoint.V1.AppEventLocalizations.WithID {
	...
	public struct AppEventScreenshots {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppEventScreenshotsResponse> {
