...
extension EnterpriseAPIEndpoint.V2.AppStoreVersionExperiments {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppStoreVersionExperimentV2Response> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppStoreVersionExperimentV2UpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppStoreVersionExperimentV2Response> {
