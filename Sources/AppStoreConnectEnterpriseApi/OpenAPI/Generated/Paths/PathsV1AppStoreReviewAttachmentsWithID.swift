...
extension EnterpriseAPIEndpoint.V1.AppStoreReviewAttachments {
	...
	public struct WithID {
		...
		public func get(fieldsAppStoreReviewAttachments: [FieldsAppStoreReviewAttachments]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectEnterpriseApi.AppStoreReviewAttachmentResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppStoreReviewAttachmentUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppStoreReviewAttachmentResponse> {
