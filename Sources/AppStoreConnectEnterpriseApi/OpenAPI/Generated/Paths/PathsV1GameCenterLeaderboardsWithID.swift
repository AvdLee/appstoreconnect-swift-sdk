...
extension EnterpriseAPIEndpoint.V1.GameCenterLeaderboards {
	...
	public struct WithID {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.GameCenterLeaderboardUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.GameCenterLeaderboardResponse> {
