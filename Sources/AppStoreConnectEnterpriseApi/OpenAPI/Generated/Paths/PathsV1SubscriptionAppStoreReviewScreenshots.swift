...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct SubscriptionAppStoreReviewScreenshots {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.SubscriptionAppStoreReviewScreenshotCreateRequest) -> Request<AppStoreConnectEnterpriseApi.SubscriptionAppStoreReviewScreenshotResponse> {
