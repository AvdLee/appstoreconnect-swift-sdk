...
extension EnterpriseAPIEndpoint.V1.CiXcodeVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.CiXcodeVersionResponse> {
