...
extension EnterpriseAPIEndpoint.V1.AppCustomProductPages {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.AppCustomProductPageResponse> {
		...
		public func patch(_ body: AppStoreConnectEnterpriseApi.AppCustomProductPageUpdateRequest) -> Request<AppStoreConnectEnterpriseApi.AppCustomProductPageResponse> {
