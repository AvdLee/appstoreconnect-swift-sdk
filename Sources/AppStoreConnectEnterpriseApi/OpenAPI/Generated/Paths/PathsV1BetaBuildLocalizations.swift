...
extension EnterpriseAPIEndpoint.V1 {
	...
	public struct BetaBuildLocalizations {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectEnterpriseApi.BetaBuildLocalizationsResponse> {
		...
		public func post(_ body: AppStoreConnectEnterpriseApi.BetaBuildLocalizationCreateRequest) -> Request<AppStoreConnectEnterpriseApi.BetaBuildLocalizationResponse> {
