...
public struct XcodeMetrics: Codable {
	...
	public struct ProductDatum: Codable {
		...
		public final class MetricCategory: Codable {
			public let identifier: AppStoreConnectEnterpriseApi.MetricCategory?
			...
			public init(identifier: AppStoreConnectEnterpriseApi.MetricCategory? = nil, metrics: [Metric]? = nil) {
				self.identifier = identifier
			...
			public init(from decoder: Decoder) throws {
				let values = try decoder.container(keyedBy: StringCodingKey.self)
				self.identifier = try values.decodeIfPresent(AppStoreConnectEnterpriseApi.MetricCategory.self, forKey: "identifier")
