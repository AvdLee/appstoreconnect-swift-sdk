...
extension APIEndpoint.V1.PassTypeIDs {
	...
	public struct WithID {
		...
		public func patch(_ body: AppStoreConnect_Swift_SDK.PassTypeIDUpdateRequest) -> Request<AppStoreConnect_Swift_SDK.PassTypeIDResponse> {
