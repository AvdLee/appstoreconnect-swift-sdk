...
extension APIEndpoint.V1.AccessibilityDeclarations {
	...
	public struct WithID {
		...
		public func get(fieldsAccessibilityDeclarations: [FieldsAccessibilityDeclarations]? = nil) -> Request<AppStoreConnectApi.AccessibilityDeclarationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AccessibilityDeclarationUpdateRequest) -> Request<AppStoreConnectApi.AccessibilityDeclarationResponse> {
