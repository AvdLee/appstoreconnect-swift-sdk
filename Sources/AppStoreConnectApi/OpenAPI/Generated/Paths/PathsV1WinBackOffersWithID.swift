...
extension APIEndpoint.V1.WinBackOffers {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.WinBackOfferResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.WinBackOfferUpdateRequest) -> Request<AppStoreConnectApi.WinBackOfferResponse> {
