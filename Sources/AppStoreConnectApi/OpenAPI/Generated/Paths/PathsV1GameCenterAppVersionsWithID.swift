...
extension APIEndpoint.V1.GameCenterAppVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterAppVersionResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterAppVersionUpdateRequest) -> Request<AppStoreConnectApi.GameCenterAppVersionResponse> {
