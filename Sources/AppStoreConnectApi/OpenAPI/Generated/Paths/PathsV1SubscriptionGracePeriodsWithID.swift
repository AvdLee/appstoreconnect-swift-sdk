...
extension APIEndpoint.V1.SubscriptionGracePeriods {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionGracePeriods: [FieldsSubscriptionGracePeriods]? = nil) -> Request<AppStoreConnectApi.SubscriptionGracePeriodResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionGracePeriodUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionGracePeriodResponse> {
