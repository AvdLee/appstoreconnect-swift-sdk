...
extension APIEndpoint.V1.GameCenterMatchmakingRuleSets {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterMatchmakingRuleSetResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterMatchmakingRuleSetUpdateRequest) -> Request<AppStoreConnectApi.GameCenterMatchmakingRuleSetResponse> {
