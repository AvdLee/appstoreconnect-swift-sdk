...
extension APIEndpoint.V1.GameCenterActivityVersionReleases {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterActivityVersionReleases: [FieldsGameCenterActivityVersionReleases]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterActivityVersionReleaseResponse> {
