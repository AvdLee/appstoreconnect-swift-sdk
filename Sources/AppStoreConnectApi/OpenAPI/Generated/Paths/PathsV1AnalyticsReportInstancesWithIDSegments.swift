...
extension APIEndpoint.V1.AnalyticsReportInstances.WithID {
	...
	public struct Segments {
		...
		public func get(fieldsAnalyticsReportSegments: [FieldsAnalyticsReportSegments]? = nil, limit: Int? = nil) -> Request<AppStoreConnectApi.AnalyticsReportSegmentsResponse> {
