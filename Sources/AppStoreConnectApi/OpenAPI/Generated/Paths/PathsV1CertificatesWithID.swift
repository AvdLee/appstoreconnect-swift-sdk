...
extension APIEndpoint.V1.Certificates {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.CertificateResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.CertificateUpdateRequest) -> Request<AppStoreConnectApi.CertificateResponse> {
