...
extension APIEndpoint.V1.SubscriptionOfferCodeOneTimeUseCodes {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionOfferCodeOneTimeUseCodes: [FieldsSubscriptionOfferCodeOneTimeUseCodes]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.SubscriptionOfferCodeOneTimeUseCodeResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionOfferCodeOneTimeUseCodeUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionOfferCodeOneTimeUseCodeResponse> {
