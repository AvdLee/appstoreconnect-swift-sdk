...
extension APIEndpoint.V1.AppEventVideoClips {
	...
	public struct WithID {
		...
		public func get(fieldsAppEventVideoClips: [FieldsAppEventVideoClips]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.AppEventVideoClipResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppEventVideoClipUpdateRequest) -> Request<AppStoreConnectApi.AppEventVideoClipResponse> {
