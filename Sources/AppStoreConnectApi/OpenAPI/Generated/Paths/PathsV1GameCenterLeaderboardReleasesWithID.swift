...
extension APIEndpoint.V1.GameCenterLeaderboardReleases {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterLeaderboardReleases: [FieldsGameCenterLeaderboardReleases]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterLeaderboardReleaseResponse> {
