...
extension APIEndpoint.V1.Builds.WithID {
	...
	public struct AppEncryptionDeclaration {
		...
		public func get(fieldsAppEncryptionDeclarations: [FieldsAppEncryptionDeclarations]? = nil) -> Request<AppStoreConnectApi.AppEncryptionDeclarationWithoutIncludesResponse> {
