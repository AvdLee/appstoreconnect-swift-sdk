...
extension APIEndpoint.V1 {
	...
	public struct AlternativeDistributionDomains {
		...
		public func get(fieldsAlternativeDistributionDomains: [FieldsAlternativeDistributionDomains]? = nil, limit: Int? = nil) -> Request<AppStoreConnectApi.AlternativeDistributionDomainsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.AlternativeDistributionDomainCreateRequest) -> Request<AppStoreConnectApi.AlternativeDistributionDomainResponse> {
