...
extension APIEndpoint.V1.AppCustomProductPageLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppCustomProductPageLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppCustomProductPageLocalizationUpdateRequest) -> Request<AppStoreConnectApi.AppCustomProductPageLocalizationResponse> {
