...
extension APIEndpoint.V1 {
	...
	public struct GameCenterLeaderboardSetMemberLocalizations {
		...
		public func get(parameters: GetParameters) -> Request<AppStoreConnectApi.GameCenterLeaderboardSetMemberLocalizationsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.GameCenterLeaderboardSetMemberLocalizationCreateRequest) -> Request<AppStoreConnectApi.GameCenterLeaderboardSetMemberLocalizationResponse> {
