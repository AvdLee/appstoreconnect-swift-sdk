...
extension APIEndpoint.V1.SubscriptionLocalizations {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionLocalizations: [FieldsSubscriptionLocalizations]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.SubscriptionLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionLocalizationUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionLocalizationResponse> {
