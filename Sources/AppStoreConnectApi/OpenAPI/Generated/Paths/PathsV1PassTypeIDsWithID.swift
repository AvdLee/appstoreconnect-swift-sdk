...
extension APIEndpoint.V1.PassTypeIDs {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.PassTypeIDResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.PassTypeIDUpdateRequest) -> Request<AppStoreConnectApi.PassTypeIDResponse> {
