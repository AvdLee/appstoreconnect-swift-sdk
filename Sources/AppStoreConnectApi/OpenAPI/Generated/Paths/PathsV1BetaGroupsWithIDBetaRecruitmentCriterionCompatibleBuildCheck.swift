...
extension APIEndpoint.V1.BetaGroups.WithID {
	...
	public struct BetaRecruitmentCriterionCompatibleBuildCheck {
		...
		public func get(fieldsBetaRecruitmentCriterionCompatibleBuildChecks: [FieldsBetaRecruitmentCriterionCompatibleBuildChecks]? = nil) -> Request<AppStoreConnectApi.BetaRecruitmentCriterionCompatibleBuildCheckResponse> {
