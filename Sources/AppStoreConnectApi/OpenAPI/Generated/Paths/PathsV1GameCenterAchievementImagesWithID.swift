...
extension APIEndpoint.V1.GameCenterAchievementImages {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterAchievementImages: [FieldsGameCenterAchievementImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterAchievementImageResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterAchievementImageUpdateRequest) -> Request<AppStoreConnectApi.GameCenterAchievementImageResponse> {
