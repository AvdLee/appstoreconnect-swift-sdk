...
extension APIEndpoint.V1.AppCustomProductPages {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppCustomProductPageResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppCustomProductPageUpdateRequest) -> Request<AppStoreConnectApi.AppCustomProductPageResponse> {
