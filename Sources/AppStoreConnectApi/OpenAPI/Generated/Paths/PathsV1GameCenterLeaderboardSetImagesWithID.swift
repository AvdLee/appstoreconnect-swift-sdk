...
extension APIEndpoint.V1.GameCenterLeaderboardSetImages {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterLeaderboardSetImages: [FieldsGameCenterLeaderboardSetImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterLeaderboardSetImageResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterLeaderboardSetImageUpdateRequest) -> Request<AppStoreConnectApi.GameCenterLeaderboardSetImageResponse> {
