...
extension APIEndpoint.V1.GameCenterLeaderboardLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterLeaderboardLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterLeaderboardLocalizationUpdateRequest) -> Request<AppStoreConnectApi.GameCenterLeaderboardLocalizationResponse> {
