...
extension APIEndpoint.V1.GameCenterDetails.WithID.Relationships {
	...
	public struct GameCenterAchievements {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectApi.GameCenterDetailGameCenterAchievementsLinkagesResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterDetailGameCenterAchievementsLinkagesRequest) -> Request<Void> {
