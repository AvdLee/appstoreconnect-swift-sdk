...
extension APIEndpoint.V1 {
	...
	public struct PassTypeIDs {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.PassTypeIDsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.PassTypeIDCreateRequest) -> Request<AppStoreConnectApi.PassTypeIDResponse> {
