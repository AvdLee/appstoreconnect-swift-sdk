...
extension APIEndpoint.V1.Subscriptions.WithID.Relationships {
	...
	public struct Prices {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectApi.SubscriptionPricesLinkagesResponse> {
		...
		public func delete(_ body: AppStoreConnectApi.SubscriptionPricesLinkagesRequest) -> Request<Void> {
