...
extension APIEndpoint.V1.InAppPurchaseContents {
	...
	public struct WithID {
		...
		public func get(fieldsInAppPurchaseContents: [FieldsInAppPurchaseContents]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.InAppPurchaseContentResponse> {
