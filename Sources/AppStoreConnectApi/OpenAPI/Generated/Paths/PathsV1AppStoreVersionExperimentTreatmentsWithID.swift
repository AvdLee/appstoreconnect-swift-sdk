...
extension APIEndpoint.V1.AppStoreVersionExperimentTreatments {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppStoreVersionExperimentTreatmentResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppStoreVersionExperimentTreatmentUpdateRequest) -> Request<AppStoreConnectApi.AppStoreVersionExperimentTreatmentResponse> {
