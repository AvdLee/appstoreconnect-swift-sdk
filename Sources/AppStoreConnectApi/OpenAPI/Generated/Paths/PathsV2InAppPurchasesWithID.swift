...
extension APIEndpoint.V2.InAppPurchases {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.InAppPurchaseV2Response> {
		...
		public func patch(_ body: AppStoreConnectApi.InAppPurchaseV2UpdateRequest) -> Request<AppStoreConnectApi.InAppPurchaseV2Response> {
