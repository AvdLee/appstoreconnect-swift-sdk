...
extension APIEndpoint.V1 {
	...
	public struct MerchantIDs {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.MerchantIDsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.MerchantIDCreateRequest) -> Request<AppStoreConnectApi.MerchantIDResponse> {
