...
extension APIEndpoint.V1.AppStoreVersionExperimentTreatments.WithID.Relationships {
	...
	public struct AppStoreVersionExperimentTreatmentLocalizations {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectApi.AppStoreVersionExperimentTreatmentAppStoreVersionExperimentTreatmentLocalizationsLinkagesResponse> {
