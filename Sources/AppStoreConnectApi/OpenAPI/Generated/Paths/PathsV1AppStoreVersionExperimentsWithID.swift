...
extension APIEndpoint.V1.AppStoreVersionExperiments {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppStoreVersionExperimentResponse> {
		...
		@available(*, deprecated, message: "Deprecated")
		public func patch(_ body: AppStoreConnectApi.AppStoreVersionExperimentUpdateRequest) -> Request<AppStoreConnectApi.AppStoreVersionExperimentResponse> {
