...
extension APIEndpoint.V1.GameCenterLeaderboardImages {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterLeaderboardImages: [FieldsGameCenterLeaderboardImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterLeaderboardImageResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterLeaderboardImageUpdateRequest) -> Request<AppStoreConnectApi.GameCenterLeaderboardImageResponse> {
