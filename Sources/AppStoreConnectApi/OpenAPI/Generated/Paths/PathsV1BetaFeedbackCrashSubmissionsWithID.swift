...
extension APIEndpoint.V1.BetaFeedbackCrashSubmissions {
	...
	public struct WithID {
		...
		public func get(fieldsBetaFeedbackCrashSubmissions: [FieldsBetaFeedbackCrashSubmissions]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.BetaFeedbackCrashSubmissionResponse> {
