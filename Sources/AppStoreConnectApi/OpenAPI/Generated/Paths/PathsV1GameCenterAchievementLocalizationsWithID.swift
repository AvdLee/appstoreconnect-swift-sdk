...
extension APIEndpoint.V1.GameCenterAchievementLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterAchievementLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterAchievementLocalizationUpdateRequest) -> Request<AppStoreConnectApi.GameCenterAchievementLocalizationResponse> {
