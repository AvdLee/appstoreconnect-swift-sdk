...
extension APIEndpoint.V1.GameCenterGroups.WithID.Relationships {
	...
	public struct GameCenterLeaderboardSets {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectApi.GameCenterGroupGameCenterLeaderboardSetsLinkagesResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterGroupGameCenterLeaderboardSetsLinkagesRequest) -> Request<Void> {
