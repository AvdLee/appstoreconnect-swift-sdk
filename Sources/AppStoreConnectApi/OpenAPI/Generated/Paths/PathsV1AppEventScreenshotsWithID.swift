...
extension APIEndpoint.V1.AppEventScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsAppEventScreenshots: [FieldsAppEventScreenshots]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.AppEventScreenshotResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppEventScreenshotUpdateRequest) -> Request<AppStoreConnectApi.AppEventScreenshotResponse> {
