...
extension APIEndpoint.V1.GameCenterAchievements {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterAchievementResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterAchievementUpdateRequest) -> Request<AppStoreConnectApi.GameCenterAchievementResponse> {
