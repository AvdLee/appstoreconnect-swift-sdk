...
extension APIEndpoint.V1.GameCenterMatchmakingQueues {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterMatchmakingQueues: [FieldsGameCenterMatchmakingQueues]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterMatchmakingQueueResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterMatchmakingQueueUpdateRequest) -> Request<AppStoreConnectApi.GameCenterMatchmakingQueueResponse> {
