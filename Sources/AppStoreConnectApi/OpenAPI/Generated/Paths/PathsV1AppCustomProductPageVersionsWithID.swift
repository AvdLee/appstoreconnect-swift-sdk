...
extension APIEndpoint.V1.AppCustomProductPageVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppCustomProductPageVersionResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppCustomProductPageVersionUpdateRequest) -> Request<AppStoreConnectApi.AppCustomProductPageVersionResponse> {
