...
extension APIEndpoint.V1.GameCenterLeaderboards.WithID.Relationships {
	...
	public struct GroupLeaderboard {
		...
		public var get: Request<AppStoreConnectApi.GameCenterLeaderboardGroupLeaderboardLinkageResponse> {
			Request(path: path, method: "GET", id: "gameCenterLeaderboards_groupLeaderboard_getToOneRelationship")
		}

		@available(*, deprecated, message: "Deprecated")
		public func patch(_ body: AppStoreConnectApi.GameCenterLeaderboardGroupLeaderboardLinkageRequest) -> Request<Void> {
