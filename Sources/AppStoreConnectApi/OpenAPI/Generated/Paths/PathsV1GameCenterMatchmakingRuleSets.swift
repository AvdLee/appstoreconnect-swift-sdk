...
extension APIEndpoint.V1 {
	...
	public struct GameCenterMatchmakingRuleSets {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterMatchmakingRuleSetsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.GameCenterMatchmakingRuleSetCreateRequest) -> Request<AppStoreConnectApi.GameCenterMatchmakingRuleSetResponse> {
