...
extension APIEndpoint.V1.SubscriptionIntroductoryOffers {
	...
	public struct WithID {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionIntroductoryOfferUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionIntroductoryOfferResponse> {
