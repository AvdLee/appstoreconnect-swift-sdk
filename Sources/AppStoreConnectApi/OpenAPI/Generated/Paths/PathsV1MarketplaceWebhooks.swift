...
extension APIEndpoint.V1 {
	...
	public struct MarketplaceWebhooks {
		...
		public func get(fieldsMarketplaceWebhooks: [FieldsMarketplaceWebhooks]? = nil, limit: Int? = nil) -> Request<AppStoreConnectApi.MarketplaceWebhooksResponse> {
		...
		public func post(_ body: AppStoreConnectApi.MarketplaceWebhookCreateRequest) -> Request<AppStoreConnectApi.MarketplaceWebhookResponse> {
