...
extension APIEndpoint.V1.GameCenterChallengeLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterChallengeLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterChallengeLocalizationUpdateRequest) -> Request<AppStoreConnectApi.GameCenterChallengeLocalizationResponse> {
