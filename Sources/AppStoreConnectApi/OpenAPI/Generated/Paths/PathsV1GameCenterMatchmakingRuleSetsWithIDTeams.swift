...
extension APIEndpoint.V1.GameCenterMatchmakingRuleSets.WithID {
	...
	public struct Teams {
		...
		public func get(fieldsGameCenterMatchmakingTeams: [FieldsGameCenterMatchmakingTeams]? = nil, limit: Int? = nil) -> Request<AppStoreConnectApi.GameCenterMatchmakingTeamsResponse> {
