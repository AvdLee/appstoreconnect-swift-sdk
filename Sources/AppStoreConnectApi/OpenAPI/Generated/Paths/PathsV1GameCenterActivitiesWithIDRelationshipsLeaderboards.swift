...
extension APIEndpoint.V1.GameCenterActivities.WithID.Relationships {
	...
	public struct Leaderboards {
		...
		public func post(_ body: AppStoreConnectApi.GameCenterActivityLeaderboardsLinkagesRequest) -> Request<Void> {
			Request(path: path, method: "POST", body: body, id: "gameCenterActivities_leaderboards_createToManyRelationship")
		}

		public func delete(_ body: AppStoreConnectApi.GameCenterActivityLeaderboardsLinkagesRequest) -> Request<Void> {
