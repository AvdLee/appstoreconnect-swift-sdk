...
extension APIEndpoint.V1.GameCenterActivityLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterActivityLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterActivityLocalizationUpdateRequest) -> Request<AppStoreConnectApi.GameCenterActivityLocalizationResponse> {
