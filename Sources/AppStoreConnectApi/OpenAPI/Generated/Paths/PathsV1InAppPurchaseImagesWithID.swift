...
extension APIEndpoint.V1.InAppPurchaseImages {
	...
	public struct WithID {
		...
		public func get(fieldsInAppPurchaseImages: [FieldsInAppPurchaseImages]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.InAppPurchaseImageResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.InAppPurchaseImageUpdateRequest) -> Request<AppStoreConnectApi.InAppPurchaseImageResponse> {
