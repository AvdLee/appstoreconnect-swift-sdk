...
extension APIEndpoint.V1.SubscriptionGroups {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.SubscriptionGroupResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionGroupUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionGroupResponse> {
