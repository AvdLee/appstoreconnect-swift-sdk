...
extension APIEndpoint.V1.InAppPurchaseAppStoreReviewScreenshots {
	...
	public struct WithID {
		...
		public func get(fieldsInAppPurchaseAppStoreReviewScreenshots: [FieldsInAppPurchaseAppStoreReviewScreenshots]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.InAppPurchaseAppStoreReviewScreenshotResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.InAppPurchaseAppStoreReviewScreenshotUpdateRequest) -> Request<AppStoreConnectApi.InAppPurchaseAppStoreReviewScreenshotResponse> {
