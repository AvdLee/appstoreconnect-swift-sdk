...
extension APIEndpoint.V1.AppEventLocalizations {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppEventLocalizationResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppEventLocalizationUpdateRequest) -> Request<AppStoreConnectApi.AppEventLocalizationResponse> {
