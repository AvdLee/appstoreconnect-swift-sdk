...
extension APIEndpoint.V1.GameCenterLeaderboardSetReleases {
	...
	public struct WithID {
		...
		public func get(fieldsGameCenterLeaderboardSetReleases: [FieldsGameCenterLeaderboardSetReleases]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.GameCenterLeaderboardSetReleaseResponse> {
