...
extension APIEndpoint.V1 {
	...
	public struct GameCenterMatchmakingQueues {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterMatchmakingQueuesResponse> {
		...
		public func post(_ body: AppStoreConnectApi.GameCenterMatchmakingQueueCreateRequest) -> Request<AppStoreConnectApi.GameCenterMatchmakingQueueResponse> {
