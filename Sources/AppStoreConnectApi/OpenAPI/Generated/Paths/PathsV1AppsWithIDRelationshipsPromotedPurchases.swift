...
extension APIEndpoint.V1.Apps.WithID.Relationships {
	...
	public struct PromotedPurchases {
		...
		public func get(limit: Int? = nil) -> Request<AppStoreConnectApi.AppPromotedPurchasesLinkagesResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppPromotedPurchasesLinkagesRequest) -> Request<Void> {
