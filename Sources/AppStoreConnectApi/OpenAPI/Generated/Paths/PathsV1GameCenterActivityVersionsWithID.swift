...
extension APIEndpoint.V1.GameCenterActivityVersions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterActivityVersionResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterActivityVersionUpdateRequest) -> Request<AppStoreConnectApi.GameCenterActivityVersionResponse> {
