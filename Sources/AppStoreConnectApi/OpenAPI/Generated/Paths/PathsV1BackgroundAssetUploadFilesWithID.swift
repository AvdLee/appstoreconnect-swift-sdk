...
extension APIEndpoint.V1.BackgroundAssetUploadFiles {
	...
	public struct WithID {
		...
		public func get(fieldsBackgroundAssetUploadFiles: [FieldsBackgroundAssetUploadFiles]? = nil) -> Request<AppStoreConnectApi.BackgroundAssetUploadFileResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.BackgroundAssetUploadFileUpdateRequest) -> Request<AppStoreConnectApi.BackgroundAssetUploadFileResponse> {
