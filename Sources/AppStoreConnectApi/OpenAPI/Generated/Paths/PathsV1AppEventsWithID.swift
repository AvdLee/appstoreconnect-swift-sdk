...
extension APIEndpoint.V1.AppEvents {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AppEventResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.AppEventUpdateRequest) -> Request<AppStoreConnectApi.AppEventResponse> {
