...
extension APIEndpoint.V1 {
	...
	public struct GameCenterGroups {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterGroupsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.GameCenterGroupCreateRequest) -> Request<AppStoreConnectApi.GameCenterGroupResponse> {
