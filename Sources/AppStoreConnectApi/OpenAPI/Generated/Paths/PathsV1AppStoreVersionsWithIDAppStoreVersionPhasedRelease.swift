...
extension APIEndpoint.V1.AppStoreVersions.WithID {
	...
	public struct AppStoreVersionPhasedRelease {
		...
		public func get(fieldsAppStoreVersionPhasedReleases: [FieldsAppStoreVersionPhasedReleases]? = nil) -> Request<AppStoreConnectApi.AppStoreVersionPhasedReleaseWithoutIncludesResponse> {
