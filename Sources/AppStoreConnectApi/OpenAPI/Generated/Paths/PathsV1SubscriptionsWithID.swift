...
extension APIEndpoint.V1.Subscriptions {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.SubscriptionResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionResponse> {
