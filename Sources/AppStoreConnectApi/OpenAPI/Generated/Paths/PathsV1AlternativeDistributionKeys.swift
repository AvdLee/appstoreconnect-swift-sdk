...
extension APIEndpoint.V1 {
	...
	public struct AlternativeDistributionKeys {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.AlternativeDistributionKeysResponse> {
		...
		public func post(_ body: AppStoreConnectApi.AlternativeDistributionKeyCreateRequest) -> Request<AppStoreConnectApi.AlternativeDistributionKeyResponse> {
