...
extension APIEndpoint.V1 {
	...
	public struct ReviewSubmissions {
		...
		public func get(parameters: GetParameters) -> Request<AppStoreConnectApi.ReviewSubmissionsResponse> {
		...
		public func post(_ body: AppStoreConnectApi.ReviewSubmissionCreateRequest) -> Request<AppStoreConnectApi.ReviewSubmissionResponse> {
