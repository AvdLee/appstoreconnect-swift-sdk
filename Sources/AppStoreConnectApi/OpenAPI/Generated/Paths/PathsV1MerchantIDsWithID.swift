...
extension APIEndpoint.V1.MerchantIDs {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.MerchantIDResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.MerchantIDUpdateRequest) -> Request<AppStoreConnectApi.MerchantIDResponse> {
