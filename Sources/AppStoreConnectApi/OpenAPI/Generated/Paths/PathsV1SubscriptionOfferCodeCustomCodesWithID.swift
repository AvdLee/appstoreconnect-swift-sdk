...
extension APIEndpoint.V1.SubscriptionOfferCodeCustomCodes {
	...
	public struct WithID {
		...
		public func get(fieldsSubscriptionOfferCodeCustomCodes: [FieldsSubscriptionOfferCodeCustomCodes]? = nil, include: [Include]? = nil) -> Request<AppStoreConnectApi.SubscriptionOfferCodeCustomCodeResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.SubscriptionOfferCodeCustomCodeUpdateRequest) -> Request<AppStoreConnectApi.SubscriptionOfferCodeCustomCodeResponse> {
