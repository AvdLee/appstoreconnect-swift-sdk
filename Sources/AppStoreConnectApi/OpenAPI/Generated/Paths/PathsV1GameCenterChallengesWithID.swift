...
extension APIEndpoint.V1.GameCenterChallenges {
	...
	public struct WithID {
		...
		public func get(parameters: GetParameters? = nil) -> Request<AppStoreConnectApi.GameCenterChallengeResponse> {
		...
		public func patch(_ body: AppStoreConnectApi.GameCenterChallengeUpdateRequest) -> Request<AppStoreConnectApi.GameCenterChallengeResponse> {
