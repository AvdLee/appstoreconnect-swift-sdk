...
public struct XcodeMetrics: Codable {
	...
	public struct ProductDatum: Codable {
		...
		public final class MetricCategory: Codable {
			public let identifier: AppStoreConnectApi.MetricCategory?
			...
			public init(identifier: AppStoreConnectApi.MetricCategory? = nil, metrics: [Metric]? = nil) {
				self.identifier = identifier
			...
			public init(from decoder: Decoder) throws {
				let values = try decoder.container(keyedBy: StringCodingKey.self)
				self.identifier = try values.decodeIfPresent(AppStoreConnectApi.MetricCategory.self, forKey: "identifier")
